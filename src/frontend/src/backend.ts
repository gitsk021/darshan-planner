...
export class Backend implements backendInterface {
    ...
    async getItinerary(arg0: bigint): Promise<Itinerary> {
        if (this.processError) {
            try {
    ...
    async saveItinerary(arg0: CreateItinerary): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveItinerary(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
